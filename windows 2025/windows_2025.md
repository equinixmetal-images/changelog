# Changelog for windows-2025_06-04-2026_std
## Image information
```
    Edition: Windows Server 2025 Standard
    Filename: equinixmetal-2k25stduefi-from-golden_06_04_2026_308.raw.tar.gz
    Size: 11.0 GB
    SHA1: 5841F001A238728DF3DF68F961168FD9A3540A56
```
...
```
    ...
    List of KB updates: KB5066131 KB5078740 KB5078739
```
...
```
# Changelog for windows-2025_18-03-2026_std
## Image information
```
    Edition: Windows Server 2025 Standard
    Filename: equinixmetal-2k25stduefi-from-golden_18_03_2026_304.raw.tar.gz
    Size: TBD
    SHA1: TBD
```
...
## Software and Driver versions:
```
    Cloudbase-init version: TBD
    Drivers and version: TBD
```
...
## Windows updates:
```
    Number of installed updates: TBD
    List of KB updates: TBD
```
